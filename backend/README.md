...
## Project Structure
    ...
    ├── empty_union_dev_104270  # Django project configurations
...
1. Clone this repo and `cd empty_union_dev_104270`
...
2. Clone this repo and `cd empty_union_dev_104270`
