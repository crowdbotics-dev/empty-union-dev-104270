"""
Django settings for empty_union_dev_104270 project.
...
ROOT_URLCONF = 'empty_union_dev_104270.urls'
...
WSGI_APPLICATION = 'empty_union_dev_104270.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_union_dev_104270 API",
    "DESCRIPTION": "API documentation for empty_union_dev_104270 App",
    "VERSION": "v1",
}
